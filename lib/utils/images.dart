...
const script = DashboardIconMenuURL + "script.png";
const campaign = DashboardIconMenuURL + "campaign.png";
const billing = DashboardIconMenuURL + "billing.png";
...
const AppDrawerURL = "assets/images/profile/";

const pofile_avatar = AppDrawerURL + "profile_avatar.png";
